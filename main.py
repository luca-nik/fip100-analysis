...
def plot_rbp_qap_comparison(df):
    """Generates the comparison chart between Raw Byte (RBP) and Quality Adjusted (QAP) Power."""
    ...
    ax1.set_title('Raw Byte Power (RBP)', fontsize=14, fontweight='bold')
    ax1.legend()
    ax1.set_ylabel('Power (EiB)', fontsize=12) 
    ...
    ax2.set_title('Quality Adjusted Power (QAP)', fontsize=14, fontweight='bold')
    ax2.legend()
    ax2.set_ylabel('Power (EiB)', fontsize=12)
